    ...
    <div className="flex flex-col w-full items-center min-h-screen bg-[#f8f8f9]">
      ...
      <div className="flex justify-center gap-16 items-baseline flex-wrap mx-4">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="p-why2 py-4 my-4 w-[16rem] text-center text-sm text-[#666]">
            Contamos con un seleccionado de profesores listos para poder
            instruirte. Tenemos clases de yoga, danza, partner, acrobatic
          </p>
          <div className='div-background_why w-[28rem] h-[16rem] bg-black rounded-2xl relative bg-[url("https://user-images.githubusercontent.com/91817152/192928635-0462d44e-a9fc-4566-a446-0b53d374b3c1.jpg")] bg-cover bg-[center_-9rem]'>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="p-why2 my-4 py-4 w-[16rem] text-center text-sm text-[#666]">
            Disfruta de las mejores clases online o presencial, contamos con
            multiples actividades para desenvolverte.
          </p>
          <div className='div-background_why w-[28rem] h-[16rem] bg-black rounded-2xl relative bg-[url("https://user-images.githubusercontent.com/91817152/192928760-1f880cc5-6d0f-404f-9fc8-cd79b90a9085.jpg")] bg-cover'>
      ...
      <div className="flex flex-col justify-center items-center text-center">
        ...
        <img className="img-cp w-2/4 self-end" src={bkgOnline} alt="background online" />
      </div>
    </div>
  );
};
