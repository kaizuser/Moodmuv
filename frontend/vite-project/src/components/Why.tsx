    ...
    <div className="flex flex-col w-full items-center min-h-screen">
      ...
      <div className="flex justify-center gap-16 items-baseline flex-wrap mx-4">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className='div-background_why w-[28rem] h-[16rem] bg-black rounded-2xl relative bg-[url("/src/assets/imagePresencial.jpg")] bg-cover bg-[center_-9rem]'>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className='div-background_why w-[28rem] h-[16rem] bg-black rounded-2xl relative bg-[url("/src/assets/imageOnline.jpg")] bg-cover'>
