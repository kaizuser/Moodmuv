...
{/* Facebook */}
              ...
              <fieldset className="flex gap-4 w-full flex-wrap">
                <button
                  ...
                  className="flex justify-center items-center px-2 w-16 ml-28 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
